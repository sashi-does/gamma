...
Initialize your local Python environment and install the required dependencies (such as `fastapi`, `streamlit`, `python-pptx`, `fastmcp`, `fpdf2` etc.)
